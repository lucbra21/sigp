...
def build(c, prescriptor, datos):
    ...
    y -= 20
    draw_centered(c, "INNOVA TRAINING CYF SL (SPORTS DATA CAMPUS)", width, y, size=12)
    y -= 20
    ...
    y = draw_paragraph(c, "\n2.1 Comisión por Matrícula Convertida", margin_x, y, width - 2*margin_x, height, font="Helvetica-Bold", size=10)
    ...
    y = draw_paragraph(c, "\n2.2 Importe de las Comisiones", margin_x, y, width - 2*margin_x, height, font="Helvetica-Bold", size=10)
    ...
    y = draw_paragraph(c, "\n2.3 Condiciones Económicas", margin_x, y, width - 2*margin_x, height, font="Helvetica-Bold", size=10)
    ...
    y = draw_paragraph(c, "\n2.4 Registro y Determinación de Comisiones", margin_x, y, width - 2*margin_x, height, font="Helvetica-Bold", size=10)
    ...
    y = draw_paragraph(c, "\n3.1 Devengo de la Comisión", margin_x, y, width - 2*margin_x, height, font="Helvetica-Bold", size=10)
    ...
    y = draw_paragraph(c, "\n3.2 Validación de las Comisiones", margin_x, y, width - 2*margin_x, height, font="Helvetica-Bold", size=10)
    ...
    y = draw_paragraph(c, "\n3.3 Liquidación y Pago", margin_x, y, width - 2*margin_x, height, font="Helvetica-Bold", size=10)
    ...
    y = draw_paragraph(c, "\n3.4 Condiciones para el Pago", margin_x, y, width - 2*margin_x, height, font="Helvetica-Bold", size=10)
    ...
    y = draw_paragraph(c, "\n4.3 Sistema de Cuenta Corriente", margin_x, y, width - 2*margin_x, height, font="Helvetica-Bold", size=10)
    ...
    # ==========================================
    # FINAL: CAJAS DE FIRMA (Ancladas al fondo)
    # ==========================================
    # # Si queda poco espacio para las firmas, forzamos un salto de página
    # if y < 250:
    #     c.showPage()
    #     draw_header(c, width, height)
        
    # # ES VITAL FIJAR LA POSICIÓN 'Y' EN 150. 
    # # Tu controlador pega el PNG de Jesús exactamente en y=160.
    # y_sig_base = 150
    # c.setFont("Helvetica", 10)
    
    # # Caja Izquierda: Firma Prescriptor
    # c.drawString(80, y_sig_base + 65, "Firma del Prescriptor:")
    # c.drawString(80, y_sig_base + 53, nombre_representante)
    # c.rect(80, y_sig_base, 220, 55)
    
    # # Caja Derecha: Firma Presidente
    # c.drawString(320, y_sig_base + 65, "Firma del Presidente:")
    # c.drawString(320, y_sig_base + 53, "Jesús Serrano Sanz")
    # c.drawString(320, y_sig_base + 41, "Presidente y Administrador Único")

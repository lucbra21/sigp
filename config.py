...
class Config:
    ...
    INTERNAL_NOTIFICATION_EMAILS = os.getenv("INTERNAL_NOTIFICATION_EMAILS", "info@sportsdatacampus.com")
    ...
    PRESIDENT_EMAIL = os.getenv("PRESIDENT_EMAIL", "jesus.serrano@eniit.es")
